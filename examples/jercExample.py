...
print("\n\nSingle JEC level:\n===================")
#JSON (JEC,single)
cset = core.CorrectionSet.from_file("2016preVFP_UL/jet_jerc.json.gz")
csetAK8 = core.CorrectionSet.from_file("2016preVFP_UL/fatJet_jerc.json.gz")
print("JSON access to: {}_{}_{} and _{}".format(jec, lvl, algo, algoAK8))
sf=cset["{}_{}_{}".format(jec, lvl, algo)]
sfAK8=cset["{}_{}_{}".format(jec, lvl, algoAK8)]
...
sfAK8=cset.compound["{}_{}_{}".format(jec, compoundLevel, algoAK8)]
print([input.name for input in sf.inputs])
...
sfAK8=cset["{}_{}_{}".format(jer, ResolutionChoice, algoAK8)]
print([input.name for input in sf.inputs])
